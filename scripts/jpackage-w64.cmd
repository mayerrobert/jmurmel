...
set INST=--app-version "1.4.7.0" --copyright "Copyright (C) 2020-2024 by Robert Mayer" --description "Murmel interpreter/ compiler https://jmurmel.github.io" --license-file target\jpackage-input\LICENSE --name "JMurmel"
