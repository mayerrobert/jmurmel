...
### (read-from-string str [skip [eof-obj]]) -> object, position
...
in a different order.
    ...
    (read-from-string "123 456" 4) ; ==> 456, 7
    (read-from-string "123 456" 7 'eof) ; ==> eof, 7
    (read-from-string "123 456   " 7 'eof) ; ==> eof, 10
